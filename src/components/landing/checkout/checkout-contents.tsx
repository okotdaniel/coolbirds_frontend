...
import { PriceSection } from '@/components/landing/checkout/price-section';
import { CheckoutFormGradients } from '@/components/landing/gradients/checkout-form-gradients';
...
export function CheckoutContents({ userEmail }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className={'flex flex-col md:flex-row  md:gap-16 bg-gray-50 p-6 rounded-[2vw]'}>
