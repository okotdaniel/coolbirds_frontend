...
export default function SignInForm() {
  ...
  const handleEmailLogin = async (data: FormValues) => {
    // setIsLoading(true)
    // setError(null)
    try{
      ...
      // toast.error("Wrong credentials please, ty again")
      setError("Registration good. This email might already be in use.")
      console.log(error)
    } finally {
      // setIsLoading(false)
    }
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-6">
              ...
              <form onSubmit={loginForm.handleSubmit(handleEmailLogin)} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/password-reset"  className="underline p-0 h-auto text-xs">  Forgot password? </Link>
                  </div>
              ...
              <p> Dont have an account ? 
                <Link className="text-blue-800" href="/register">    Register </Link>
              </p>
